...
public class Tree_space {
    ...
    public static Map<String, String> precompute(List<String> nodes, List<String> queries) {
    ...
    public static void main(String[] args) {
        ...
        Map<String, String> status = precompute(nodes, queries);
        ...
        for (int j = 0; j < d.size() - 1; j += 2) {
            System.out.print(operation(d.get(j),Integer.parseInt(d.get(j + 1)),status, nodes) + " ");
        }
    }
}
